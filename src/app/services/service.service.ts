...
export class ServiceService {
  ...
  getDevicesTelemetries(page: number): Observable<ResponseModel<Device[]>> {
    return this.httpClient.get<ResponseModel<Device[]>>(this.baseUrl + 'api/service/device/' + page + '/10', {
      headers: new HttpHeaders({
        Authorization: localStorage.getItem('userToken')
      })
    });
